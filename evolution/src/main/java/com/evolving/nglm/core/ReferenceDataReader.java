...
public class ReferenceDataReader<K, V extends ReferenceDataValue<K>>
{
  ...
  *****************************************/
  ...
  protected ReferenceDataReader(String readerName, String bootstrapServers, String referenceDataTopic, UnpackValue<V> unpackValue)
  {
    ...
    consumerProperties.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG,DeploymentCommon.getGuiConfigurationInitialConsumerMaxPollRecords());// speed up initial read
    consumerProperties.put(ConsumerConfig.FETCH_MAX_BYTES_CONFIG,DeploymentCommon.getGuiConfigurationInitialConsumerMaxFetchBytes());// speed up initial read
    consumerProperties.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG,DeploymentCommon.getGuiConfigurationInitialConsumerMaxFetchBytes());// speed up initial read
