      ...
      try
        {
          ...
          DateValue simulatedTime = new DateValue(RLMDateUtils.parseDate(JSONUtilities.decodeString(jsonRoot, "simulatedTime", true), "yyyy-MM-dd'T'HH:mm:ssXXX", Deployment.getDeployment(tenantID).getBaseTimeZone()));
