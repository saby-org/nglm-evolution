...
public abstract class FileSourceTask extends SourceTask
{
  ...
  ****************************************/
  ...
  protected Date readDate(String token, String record, String format, Date defaultValue, int tenantID) throws IllegalArgumentException { return FileSourceConnector.readDate(token, record, format, Deployment.getDeployment(tenantID).getTimeZone(), defaultValue); }
  protected Date readDate(String token, String record, String format, int tenantID) throws IllegalArgumentException { return FileSourceConnector.readDate(token, record, format, Deployment.getDeployment(tenantID).getTimeZone(), null); }
