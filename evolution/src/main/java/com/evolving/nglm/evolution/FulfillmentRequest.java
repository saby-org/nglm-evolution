...
public abstract class FulfillmentRequest implements DeliveryRequest
{
  ...
  *****************************************/
  ...
  private static ConnectSerde<FulfillmentRequest> commonSerde = null;
  ...
  public static ConnectSerde<FulfillmentRequest> commonSerde() { if (commonSerde == null) initializeCommonSerde(); return commonSerde; }
