...
public class GrafanaUtils
{
    ...
    try
      {
        ...
        // Iterate the existingOrgs and delete those that are neither Main Org.nor
        // t<tenantID>
  ...
  private static void createDashboardForOrg(ElasticsearchClientAPI elasticsearch, HashMap<String, Integer> existingOrgs, int tenantID, int orgID, Set<String> fileNames, HashMap<String, String> exisitingDashBoards)
  {
    for (String currentFileName : fileNames)
      {
        try
          {
            ...
            // 2- The dashboard already exists and its uid starts with t<tenantID>-
              ...
              {
                // Delete the dashboard if it is the "New General Dashboard" or the "Business -
                // Campaign Dashboard"
                // TODO -this verification will be no longer needed when all clients are
                // up-to-date-
