...
public class BonusDeliveryFileSourceConnector extends FileSourceConnector
{
  /****************************************
  *
  * attributes
  ...
  ****************************************/
  ...
  {
    return BonusDeliveryFileSourceConnectorTask.class;
  }
  
  
  /*****************************************
  *
  *  class BonusDeliveryFileSourceConnectorTask
  *
  *****************************************/

  public static class BonusDeliveryFileSourceConnectorTask extends FileSourceTask
  {
    ...
    *****************************************/
    ...
    private static final Logger log = LoggerFactory.getLogger(BonusDeliveryFileSourceConnector.class);
    ...
    *****************************************/
    ...
    @Override public void start(Map<String, String> properties)
    {
      ...
      subscriberIDService = new SubscriberIDService(Deployment.getRedisSentinels(), "BonusDeliveryFileSourceConnector-" + Integer.toString(getTaskNumber()));
    }
        ...
        if (subscriberID != null)
          {
            ...
            BonusDelivery bonusDelivery = new BonusDelivery(jsonRoot);
            result = Collections.<KeyValue>singletonList(new KeyValue(Schema.STRING_SCHEMA, bonusDelivery.getSubscriberID(), BonusDelivery.schema(), BonusDelivery.pack(bonusDelivery)));
          }
        }
