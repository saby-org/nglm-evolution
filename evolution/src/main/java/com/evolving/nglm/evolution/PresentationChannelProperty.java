...
public class PresentationChannelProperty
{
  ...
  *****************************************/
  ...
  PresentationChannelProperty(JSONObject jsonRoot) throws GUIManagerException
  {
    ...
    this.presentationChannel = Deployment.getPresentationChannels().get(JSONUtilities.decodeString(jsonRoot, "presentationChannelID", true));
    ...
    if (this.presentationChannel == null) throw new GUIManagerException("unknown presentationChannelID", JSONUtilities.decodeString(jsonRoot, "presentationChannelID", true));
  }
  ...
  *****************************************/
  ...
  public static Object pack(Object value)
  {
    ...
    struct.put("presentationChannel", presentationChannelProperty.getPresentationChannel().getID());
  ...
  public static class Property
  {
    ...
    *****************************************/
    ...
    Property(JSONObject jsonRoot) throws GUIManagerException
    {
      ...
      this.language = Deployment.getSupportedLanguages().get(JSONUtilities.decodeString(jsonRoot, "languageID", true));
      ...
      if (this.language == null) throw new GUIManagerException("language not supported", JSONUtilities.decodeString(jsonRoot, "languageID", true));
    }
    ...
    *****************************************/
    ...
    public static Object pack(Object value)
    {
      ...
      Struct struct = new Struct(schema);
      struct.put("languageID", property.getLanguage().getID());
    ...
    *****************************************/
    ...
    public static Property unpack(SchemaAndValue schemaAndValue)
    {
      ...
      Struct valueStruct = (Struct) value;
      SupportedLanguage language = Deployment.getSupportedLanguages().get(valueStruct.getString("languageID"));
      ...
      if (language == null) throw new SerializationException("language not supported: " + valueStruct.getString("languageID"));
