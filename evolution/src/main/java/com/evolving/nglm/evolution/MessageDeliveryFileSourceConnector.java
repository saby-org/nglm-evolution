...
public class MessageDeliveryFileSourceConnector extends FileSourceConnector
{
  /****************************************
  *
  * attributes
  ...
  ****************************************/
  ...
  {
    return MessageDeliveryFileSourceConnectorTask.class;
  }
  
  
  /*****************************************
  *
  *  class MessageDeliveryFileSourceConnectorTask
  *
  *****************************************/

  public static class MessageDeliveryFileSourceConnectorTask extends FileSourceTask
  {
    ...
    *****************************************/
    ...
    private static final Logger log = LoggerFactory.getLogger(MessageDeliveryFileSourceConnector.class);
    ...
    *****************************************/
    ...
    @Override public void start(Map<String, String> properties)
    {
      ...
      subscriberIDService = new SubscriberIDService(Deployment.getRedisSentinels(), "MessageDeliveryFileSourceConnector-" + Integer.toString(getTaskNumber()));
    }
        ...
        if (subscriberID != null)
          {
            ...
            MessageDelivery messageDelivery = new MessageDelivery(jsonRoot);
            result = Collections.<KeyValue>singletonList(new KeyValue(Schema.STRING_SCHEMA, messageDelivery.getSubscriberID(), MessageDelivery.schema(), MessageDelivery.pack(messageDelivery)));
          }
        }
