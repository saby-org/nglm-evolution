...
public class JourneyImpactReportDriver extends ReportDriver
{
  ...
  @Override public void produceReport(Report report, final Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    log.debug("data for report : " + topic1 + " " + topic2 + " " + JOURNEY_STATS_ES_INDEX + " " + JOURNEY_METRIC_ES_INDEX + " " + appIdPrefix);
    ...
    JourneyImpactReportESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, JOURNEY_STATS_ES_INDEX, JOURNEY_METRIC_ES_INDEX, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit }, journeyService, reportGenerationDate);
    try
      {
    ...
    JourneyImpactReportProcessor.main(new String[] { topic1, topic2, kafka, zookeeper, appIdPrefix, "1" });
    try
      {
        TimeUnit.SECONDS.sleep(1);
      } 
    ...
    JourneyImpactReportCsvWriter.main(new String[] { kafka, topic2, csvFilename }, journeyService);
