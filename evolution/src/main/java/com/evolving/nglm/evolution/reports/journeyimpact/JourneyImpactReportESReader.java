...
public class JourneyImpactReportESReader {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 5) {
            log.warn(
                "Usage : JourneyImpactReportESReader <Output Topic> <KafkaNodeList> <ZKhostList> <ESNode> <ES customer index> <ES journey index>");
            return;
        }
        ...
        log.info("Reading data from ES in "+esIndexJourneyMetric+" and "+esIndexJourneyStats+" index and writing to "+topicName+" topic.");   
        
          LinkedHashMap<String, QueryBuilder> esIndexWithQuery = new LinkedHashMap<String, QueryBuilder>();
          esIndexWithQuery.put(esIndexJourneyStats, QueryBuilders.matchAllQuery());
