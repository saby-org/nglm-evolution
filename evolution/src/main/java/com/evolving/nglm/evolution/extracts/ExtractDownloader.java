...
public class ExtractDownloader implements Runnable
{
  ...
  public ExtractDownloader(JSONObject jsonRoot, JSONObject jsonResponse, com.sun.net.httpserver.HttpExchange exchange)
  {
    ...
    threadName = JSONUtilities.decodeString(jsonRoot, "userID", true)
        + JSONUtilities.decodeString(jsonRoot, "extractName", true);
  }
  ...
  @Override public void run()
  {
    ...
    try
    {
      ...
      String csvFilenameRegex =
          jsonUserID + "_" + extractName + "_" + ".*" + "\\." + fileExtension + ReportUtils.ZIP_EXTENSION;
