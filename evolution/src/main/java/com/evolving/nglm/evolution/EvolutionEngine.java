...
public class EvolutionEngine
{
            ...
            if (loyaltyProgram != null && loyaltyProgram instanceof LoyaltyProgramPoints)
              {
                if (loyaltyProgram instanceof LoyaltyProgramPoints)
                ...
                else if (loyaltyProgram instanceof LoyaltyProgramChallenge)
                  {
                    ...
                    LoyaltyProgramState lps = subscriberProfile.getLoyaltyPrograms().get(lpID);
                    if (lps != null && lps instanceof LoyaltyProgramChallengeState)
                      {
              ...
              case POINTS:
                ...
                switch (loyaltyProgramRequest.getOperation())
                {
                    ...
                    if (currentLoyaltyProgramState == null)
                      {
                        ...
                        if (log.isDebugEnabled())
                          log.debug("new loyaltyProgramRequest : for subscriber '" + subscriberProfile.getSubscriberID() + "' : loyaltyProgramState.update(" + loyaltyProgram.getEpoch() + ", " + loyaltyProgramRequest.getOperation() + ", " + loyaltyProgram.getLoyaltyProgramName() + ", " + newTierName + ", " + now + ", " + loyaltyProgramRequest.getDeliveryRequestID() + ")");
                  ...
                  case Optout:
                    ...
                    if (log.isDebugEnabled())
                      log.debug("new loyaltyProgramRequest : for subscriber '" + subscriberProfile.getSubscriberID() + "' : loyaltyProgramState.update(" + loyaltyProgram.getEpoch() + ", " + loyaltyProgramRequest.getOperation() + ", " + loyaltyProgram.getLoyaltyProgramName() + ", " + tierName + ", " + now + ", " + loyaltyProgramRequest.getDeliveryRequestID() + ")");
              ...
              case CHALLENGE:
                ...
                switch (loyaltyProgramRequest.getOperation())
                {
                            ...
                            if ((currentLevel != null && !currentLevel.equals(newLevelName)) || (currentLevel == null && newLevelName != null))
                              {
                                ...
                                LoyaltyProgramLevelChange loyaltyProgramLevelChange = loyaltyProgramChallengeState.update(loyaltyProgram.getEpoch(), LoyaltyProgramOperation.Optin, loyaltyProgram.getLoyaltyProgramName(), newLevelName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, null);
                  ...
                  case Optout:
                    ...
                    if (oldLevel != null)
                      {
                        loyaltyProgramLevelChange = ((LoyaltyProgramChallengeState) loyaltyProgramState).update(loyaltyProgram.getEpoch(), loyaltyProgramRequest.getOperation(), loyaltyProgram.getLoyaltyProgramName(), levelName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, null);
              ...
              case MISSION:
                ...
                switch (loyaltyProgramRequest.getOperation())
                {
                    ...
                    if (currentLoyaltyProgramState == null)
                      {
                        ...
                        LoyaltyProgramStepChange stepChangeType = ((LoyaltyProgramMissionState) currentLoyaltyProgramState).update(loyaltyProgram.getEpoch(), loyaltyProgramRequest.getOperation(), loyaltyProgram.getLoyaltyProgramName(), newStepName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, false);
                            ...
                            if ((currentStep != null && !currentStep.equals(newStepName)) || (currentStep == null && newStepName != null))
                              {
                                ...
                                LoyaltyProgramStepChange loyaltyProgramStepChange = loyaltyProgramMissionState.update(loyaltyProgram.getEpoch(), LoyaltyProgramOperation.Optin, loyaltyProgram.getLoyaltyProgramName(), newStepName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, false);
                  ...
                  case Optout:
                    ...
                    LoyaltyProgramStepChange loyaltyProgramStepChange = LoyaltyProgramStepChange.NoChange;
                    boolean isMissionCompleted = ((LoyaltyProgramMissionState) loyaltyProgramState).isMissionCompleted();
                    String oldStep = ((LoyaltyProgramMissionState) loyaltyProgramState).getStepName();
                    if (oldStep != null)
                      {
                        loyaltyProgramStepChange = ((LoyaltyProgramMissionState) loyaltyProgramState).update(loyaltyProgram.getEpoch(), loyaltyProgramRequest.getOperation(), loyaltyProgram.getLoyaltyProgramName(), stepName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, isMissionCompleted);
                      }
                    else
                      {
                        loyaltyProgramState.setLoyaltyProgramExitDate(now);
                  ...
                  if (subscriberCurrentStepDefinition != null && !((LoyaltyProgramMissionState) loyaltyProgramState).isMissionCompleted())
                    {
                      ...
                      log.info("RAJ K update {} exitStep {}", loyaltyProgramMission.getGUIManagedObjectDisplay(), exitStep);
                      if (exitStep)
                        {
                          subscriberProfileUpdated = true;
                          ...
                          if (!currentStep.equals(newStep))
                            {
                              LoyaltyProgramStepChange stepChangeType = ((LoyaltyProgramMissionState) loyaltyProgramState).update(loyaltyProgram.getEpoch(), LoyaltyProgramOperation.Optin, loyaltyProgram.getLoyaltyProgramName(), newStep, now, evolutionEvent.getClass().getName(), loyaltyProgramService, newMissionStep == null);
        ...
        if (subscriberStoredToken == null)
          {
            ...
            subscriberState.getTokenChanges().add(new TokenChange(subscriberState.getSubscriberID(), SystemTime.getCurrentTime(), "", eventTokenCode, "Create", "OK", evolutionEvent.getClass().getSimpleName(), moduleID, featureID, tenantID));
            subscriberStateUpdated = true;
          }
        ...
        if (evolutionEvent instanceof PresentationLog)
          {
            ...
            subscriberState.getTokenChanges().add(new TokenChange(subscriberState.getSubscriberID(), eventDate, "", eventTokenCode, "Allocate", "OK", "PresentationLog", moduleID, featureID, tenantID));
        ...
        else if (evolutionEvent instanceof AcceptanceLog)
          {
            ...
            if (subscriberStoredToken.getAcceptedOfferID() != null)
            ...
            else
              {
                ...
                subscriberState.getTokenChanges().add(new TokenChange(subscriberState.getSubscriberID(), acceptanceLog.getEventDate(), "", eventTokenCode, "Redeem", "OK", "AcceptanceLog", moduleID, featureID, tenantID));
              }
            subscriberStateUpdated = true;
          }
  ...
  *****************************************/
    ...
    for (JourneyState journeyState : orderedJourneyStates)
      {
        ...
        *****************************************/
        ...
        if (journey == null || journeyNode == null) {
          ...
          subscriberState.addJourneyStatistic(new JourneyStatistic(context, subscriberState.getSubscriberID(), journeyState.getJourneyHistory(), journeyState, subscriberState.getSubscriberProfile().getSegmentsMap(subscriberGroupEpochReader), subscriberState.getSubscriberProfile(), now));
          inactiveJourneyStates.add(journeyState);
          continue;
        }
                        ...
                        case JourneyResult:
                          try
                          ...
                          catch (ExpressionEvaluationException|ArithmeticException e)
                            {
                              ...
                              subscriberStateUpdated = subscriberStateUpdated || metricsUpdated;
                              boolean statusUpdated = journeyState.getJourneyHistory().addStatusInformation(SystemTime.getCurrentTime(), journeyState, true);
                              subscriberState.addJourneyStatistic(new JourneyStatistic(context, subscriberState.getSubscriberID(), journeyState.getJourneyHistory(), journeyState, subscriberState.getSubscriberProfile().getSegmentsMap(subscriberGroupEpochReader), subscriberState.getSubscriberProfile(), SystemTime.getCurrentTime()));
                              inactiveJourneyStates.add(journeyState);
                              break;
                            }
                          break;
        ...
        switch (action.getActionType())
          {
            ...
            case TokenUpdate:
              ...
              {
                case New:
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getCreationDate(), TokenChange.CREATE, token, featureID, nodeName, tenantID));
                  break;
                case Bound: // must record the token creation
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getCreationDate(), TokenChange.CREATE, token, featureID, nodeName, tenantID));
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getBoundDate(), TokenChange.ALLOCATE, token, featureID, nodeName, tenantID));
                  break;
                case Redeemed: // must record the token creation & allocation
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getCreationDate(), TokenChange.CREATE, token, featureID, nodeName, tenantID));
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getBoundDate(), TokenChange.ALLOCATE, token, featureID, nodeName, tenantID));
                  subscriberState.getTokenChanges().add(generateTokenChange(subscriberState.getSubscriberID(), token.getRedeemedDate(), TokenChange.REDEEM, token, featureID, nodeName, tenantID));
                  break;
                case Expired :
                  // TODO
                  break;
  ...
  private static TokenChange generateTokenChange(String subscriberId, Date eventDateTime, String action, Token token, String journeyID, String origin, int tenantID)
  {
    return new TokenChange(subscriberId, eventDateTime, "", token.getTokenCode(), action, "OK", origin, Module.Journey_Manager, journeyID, tenantID);
  }
          ...
          try
            {
              ...
              VoucherChange voucherChange = new VoucherChange(subscriberProfile.getSubscriberID(), now, null, "", VoucherChangeAction.Redeem, voucherProfileStored.getVoucherCode(), voucherProfileStored.getVoucherID(), voucherProfileStored.getFileID(), moduleID, journeyID, origin, RESTAPIGenericReturnCodes.UNKNOWN, tenantID);
              for (VoucherProfileStored voucherStored : subscriberProfile.getVouchers())
                {
                  if (voucherStored.getVoucherCode().equals(voucherChange.getVoucherCode()) && voucherStored.getVoucherID().equals(voucherChange.getVoucherID()))
                    {
