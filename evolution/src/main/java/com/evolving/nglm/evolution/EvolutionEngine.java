              ...
              case CHALLENGE:
                ...
                switch (loyaltyProgramRequest.getOperation())
                {
                  ...
                  case Optout:
                    ...
                    LoyaltyProgramLevelChange loyaltyProgramLevelChange = ((LoyaltyProgramChallengeState) loyaltyProgramState).update(loyaltyProgram.getEpoch(), loyaltyProgramRequest.getOperation(), loyaltyProgram.getLoyaltyProgramName(), levelName, now, loyaltyProgramRequest.getDeliveryRequestID(), loyaltyProgramService, null);
                  ...
                  if (subscriberCurrentLevelDefinition != null)
                    {
                      ...
                      if (scoreEventDeclaration != null && scoreEventDeclaration.getEventClassName().equals(evolutionEvent.getClass().getName()) && evolutionEvent instanceof LoyaltyProgramScoreEvent && ((LoyaltyProgramScoreEvent) evolutionEvent).getScoreUnit() != 0) // RAJ K LoyaltyProgramPointsEvent??
                        {
                          ...
                          if (score != null)
                            {
                              ...
                              int amount = ((LoyaltyProgramScoreEvent) evolutionEvent).getScoreUnit() * subscriberCurrentLevelDefinition.getNumberOfscorePerEvent();
