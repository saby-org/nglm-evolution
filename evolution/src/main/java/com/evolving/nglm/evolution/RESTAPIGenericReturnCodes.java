...
public enum RESTAPIGenericReturnCodes
{
  ...
  DEPENDENCY_RESTRICTION(9, "DEPENDENCY_RESTRICTION", "dependency restriction"),
...
//  PASSWORD_ALREADY_USED(65,"PASSWORD_ALREADY_USED","Password already used"),
  ...
  LOWER_BALANCE(102, "LOWER_BALANCE", "Bonus balance lower than the threshold"),
  EQUAL_BALANCE(103, "EQUAL_BALANCE", "Bonus balance equal to the threshold"),
  HIGHER_BALANCE(104, "HIGHER_BALANCE", "Bonus balance higher than the threshold"),
  ...
  SALESCHANNEL_RESELLER_MISMATCH(423, "SALSCHANNEL_RESELLER_MISMATCH", "product sales channel and the reseller sales channel are not same"),
  INACTIVE_SUPPLIER(424, "INACTIVE SUPPLIER", "supplier is inactive"),
  OFFER_SUPPLIER_MISMATCH(425, "OFFER_SUPPLIER_MISMATCH", "supplier and the offer supplier are different"),
  USER_NOT_SUPPLIER(426, "USER_NOT_SUPPLIER", "user is not a supplier"),
  PUT_SUPPLIEROFFER_FAILED(427, "PUT_SUPPLIEROFFER_FAILED", "supplier offer is not created"),
  GET_SUPPLIEROFFERS_FAILED(428, "PUT_SUPPLIEROFFER_FAILED", "supplier offer is not created"),
