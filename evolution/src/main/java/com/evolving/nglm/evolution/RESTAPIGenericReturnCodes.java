...
public enum RESTAPIGenericReturnCodes
{
  ...
  NO_OFFER_ALLOCATED(504, "NO_OFFER_ALLOCATED", "Offer Optimizer is not able to allocate any offer for the pair <MSISDN, token-code>"),
  NO_OFFER_ACCEPTED(505, "NO_OFFER_ACCEPTED", "Offer Optimizer is not able to accept the offers for the pair <MSISDN, token-code>"),
  NO_OFFER_REFUSED(506, "NO_OFFER_REFUSED", "Offer Optimizer is not able to refuse the offers for the pair <MSISDN, token-code>"),
  NO_TOKENS_RETURNED(507, "NO_TOKENS_RETURNED", "Offer Optimizer is not able to return the list of tokens for current MSISDN"),
  NO_OFFERS_RETURNED(508, "NO_OFFERS_RETURNED", "Offer Optimizer is not able to return the list of offers for the pair <MSISDN, token-code>"),
