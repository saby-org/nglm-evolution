...
public abstract class ExtendedSubscriberProfile implements StateStore
{
  ...
  ****************************************/
  ...
  {
    Date today = RLMDateUtils.truncate(evaluationDate, Calendar.DATE, Deployment.getDeployment(metricHistory.getTenantID()).getTimeZone());
  ...
  {
    Date day = RLMDateUtils.truncate(evaluationDate, Calendar.DATE, Deployment.getDeployment(metricHistory.getTenantID()).getTimeZone());
  ...
  {
    Date day = RLMDateUtils.truncate(evaluationDate, Calendar.DATE, Deployment.getDeployment(metricHistory.getTenantID()).getTimeZone());
    Date startOfMonth = RLMDateUtils.truncate(day, Calendar.MONTH, Deployment.getDeployment(metricHistory.getTenantID()).getTimeZone());
