...
public class TokenUtils
{
  ...
  public static Collection<ProposedOfferDetails> getOffers(Date processingDate, DNBOToken token, SubscriberEvaluationRequest evaluationRequest, SubscriberProfile subscriberProfile, PresentationStrategy presentationStrategy, ProductService productService, ProductTypeService productTypeService, VoucherService voucherService, VoucherTypeService voucherTypeService, CatalogCharacteristicService catalogCharacteristicService, ScoringStrategyService scoringStrategyService, ReferenceDataReader<String, SubscriberGroupEpoch> subscriberGroupEpochReader, SegmentationDimensionService segmentationDimensionService, DNBOMatrixAlgorithmParameters dnboMatrixAlgorithmParameters, OfferService offerService, SupplierService supplierService, StringBuffer returnedLog, String msisdn, Supplier supplier, int tenantID) throws GetOfferException
  {
    /*
