...
@GUIDependencyDef(objectType = "campaign", serviceClass = JourneyService.class, dependencies = { "offer", "journeyobjective" , "point" , "target" , "workflow" , "mailtemplate" , "pushtemplate" , "dialogtemplate"})
