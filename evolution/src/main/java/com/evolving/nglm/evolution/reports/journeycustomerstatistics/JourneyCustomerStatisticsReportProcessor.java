 ...
 *
 */
public class JourneyCustomerStatisticsReportProcessor implements ReportProcessorFactory {

    private static final Logger log = LoggerFactory.getLogger(JourneyCustomerStatisticsReportProcessor.class);
