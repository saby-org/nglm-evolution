...
public class CustomerPointDetailsDriver extends ReportDriver
{
  ...
  @Override public void produceReport(Report report, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    CustomerPointDetailsESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, SUBSCRIBER_ES_INDEX, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit });
    try
      {
