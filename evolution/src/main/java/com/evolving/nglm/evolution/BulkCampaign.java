...
@GUIDependencyDef(objectType = "bulkCampaign", serviceClass = JourneyService.class, dependencies = {"supplier", "point" , "target" , "journeyobjective" , "mailtemplate" , "pushtemplate" , "dialogtemplate", "sourceaddress"})
