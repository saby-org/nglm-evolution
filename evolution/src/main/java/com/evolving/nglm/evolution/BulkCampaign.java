...
@GUIDependencyDef(objectType = "bulkCampaign", serviceClass = JourneyService.class, dependencies = {"supplier", "deliverable", "point" , "target" , "journeyobjective" , "mailtemplate" , "pushtemplate" , "dialogtemplate", "sourceaddress"})
