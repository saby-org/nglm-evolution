...
public class ScheduledJobConfiguration
{
  ...
  *****************************************/
  public enum Type
  {
    ...
    TDRDailyPreview("TDR-daily-preview"),
    TDRDailyDefinitive("TDR-daily-definitive"),
    TDRHourlyPreview("TDR-hourly-preview"),
    TDRHourlyDefinitive("TDR-hourly-definitive"),
    ...
    ChallengesPreview("Challenges-preview"),
    ChallengesDefinitive("Challenges-definitive"),
    MissionsPreview("Missions-preview"),
    MissionsDefinitive("Missions-definitive"),
