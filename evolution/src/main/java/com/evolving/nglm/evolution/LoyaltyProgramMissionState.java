...
public class LoyaltyProgramMissionState extends LoyaltyProgramState
{
  ...
  *****************************************/
  ...
  public LoyaltyProgramMissionState(SchemaAndValue schemaAndValue, String stepName, String previousStepName, Date stepEnrollmentDate, int currentScore, Integer previousPeriodScore, String previousPeriodStep, Date previousPeriodStartDate, LoyaltyProgramMissionHistory loyaltyProgramMissionHistory)
  {
  ...
  *****************************************/
  ...
  public static Object pack(Object value)
  {
    ...
    struct.put("previousPeriodScore", loyaltyProgramMissionState.getPreviousPeriodScore());
  ...
  *****************************************/
  ...
  public static LoyaltyProgramMissionState unpack(SchemaAndValue schemaAndValue)
  {
    ...
    return new LoyaltyProgramMissionState(schemaAndValue, stepName, previousStepName, stepEnrollmentDate, currentScore, previousPeriodScore, previousPeriodStep, previousPeriodStartDate, loyaltyProgramMissionHistory);
  }
  ...
  *****************************************/
  ...
  public LoyaltyProgramStepChange update(long loyaltyProgramEpoch, LoyaltyProgramOperation operation, String loyaltyProgramName, String toStep, Date enrollmentDate, String deliveryRequestID, LoyaltyProgramService loyaltyProgramService, Integer previousScore)
  {
