...
public class JourneyCustomerStatesReportDriver extends ReportDriver
{
  ...
  public void produceReport(Report report, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    JourneyCustomerStatesReportESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, JOURNEY_ES_INDEX, SUBSCRIBER_ES_INDEX, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit });
    try
      {
    ...
    JourneyCustomerStatesReportProcessor.main(new String[] { topic1, topic2, kafka, zookeeper, appIdPrefix, "1" });
    try
      {
        TimeUnit.SECONDS.sleep(1);
      } catch (InterruptedException e)
    ...
    JourneyCustomerStatesReportCsvWriter.main(new String[] { kafka, topic2, csvFilename });
