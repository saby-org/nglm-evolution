            ...
            switch (baseTimeUnit)
              {
                case Instant:
                  break;
                case Minute:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.MINUTE, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
                case Hour:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.HOUR, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
                case Day:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.DATE, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
                case Week:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.DAY_OF_WEEK, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
                case Month:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.MONTH, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
                case Year:
                  referenceValue = RLMDateUtils.truncate((Date) referenceValue, Calendar.YEAR, Calendar.SUNDAY, Deployment.getDeployment(subscriberEvaluationRequest.getTenantID()).getTimeZone());
                  break;
              }
            break;
      ...
      switch (baseTimeUnit)
        {
          case Instant:
            break;
          case Minute:
            date = RLMDateUtils.truncate(date, Calendar.MINUTE, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
          case Hour:
            date = RLMDateUtils.truncate(date, Calendar.HOUR, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
          case Day:
            date = RLMDateUtils.truncate(date, Calendar.DATE, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
          case Week:
            date = RLMDateUtils.truncate(date, Calendar.DAY_OF_WEEK, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
          case Month:
            date = RLMDateUtils.truncate(date, Calendar.MONTH, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
          case Year:
            date = RLMDateUtils.truncate(date, Calendar.YEAR, Calendar.SUNDAY, Deployment.getDeployment(tenantID).getTimeZone());
            break;
        }
