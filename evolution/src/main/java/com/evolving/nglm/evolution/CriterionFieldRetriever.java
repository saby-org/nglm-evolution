...
public abstract class CriterionFieldRetriever
{
  ...
  *****************************************/
  ...
  public static Object getEvaluationWeekDay(SubscriberEvaluationRequest evaluationRequest, String fieldName) { int today = RLMDateUtils.getField(evaluationRequest.getEvaluationDate(), Calendar.DAY_OF_WEEK, Deployment.getBaseTimeZone()); Set<String> evaluationWeekDay = new HashSet<String>(); evaluationWeekDay.add(getDay(today)); return evaluationWeekDay; }
  public static Object getEvaluationMonth(SubscriberEvaluationRequest evaluationRequest, String fieldName) { int today = RLMDateUtils.getField(evaluationRequest.getEvaluationDate(), Calendar.MONTH, Deployment.getBaseTimeZone()); Set<String> evaluationMonth = new HashSet<String>(); evaluationMonth.add(getMonth(today)); return evaluationMonth; }
