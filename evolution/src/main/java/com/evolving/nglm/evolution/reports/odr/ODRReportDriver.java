...
public class ODRReportDriver extends ReportDriver{
  ...
  public void produceReport(
      ...
      String[] params) {
        ...
        ODRReportESReader.main(new String[]{
            topic1, kafka, zookeeper, elasticSearch, esIndexOdr, esIndexCustomer, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit 
        });          
        try { TimeUnit.SECONDS.sleep(1); } catch (InterruptedException e) {}
        
        log.debug("PHASE 2 : process data");
        ODRReportProcessor.main(new String[]{
            topic1, topic2, kafka, zookeeper, appIdPrefix, "1"
        });
        try { TimeUnit.SECONDS.sleep(1); } catch (InterruptedException e) {}

        log.debug("PHASE 3 : write csv file ");
        ODRReportCsvWriter.main(new String[]{
