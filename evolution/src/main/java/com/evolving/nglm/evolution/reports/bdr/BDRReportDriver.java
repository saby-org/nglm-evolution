...
public class BDRReportDriver extends ReportDriver
{
  ...
  @Override public void produceReport(Report report, final Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    BDRReportESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, esIndexBdr, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit }, reportGenerationDate);
    try
      {
    ...
    BDRReportCsvWriter.main(new String[] { kafka, topic1, csvFilename });
