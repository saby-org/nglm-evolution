...
public class CustomerPointDetailsDriverOld extends ReportDriver
{
  ...
  public void produceReport(Report report, final Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    CustomerPointDetailsESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, SUBSCRIBER_ES_INDEX, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit }, reportGenerationDate);
    try
      {
    ...
    CustomerPointDetailsCsvWriter.main(new String[] { kafka, topic1, csvFilename });
