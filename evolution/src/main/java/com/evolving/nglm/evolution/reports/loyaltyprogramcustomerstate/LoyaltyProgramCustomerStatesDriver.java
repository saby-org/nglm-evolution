...
public class LoyaltyProgramCustomerStatesDriver extends ReportDriver
{
  ...
  @Override public void produceReport(Report report, final Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    final String SUBSCRIBER_ES_INDEX = getSubscriberProfileIndex(reportGenerationDate); //"subscriberprofile";
    ...
    //LoyaltyProgramCustomerStatesESReader.main(new String[] { topic1, kafka, zookeeper, elasticSearch, SUBSCRIBER_ES_INDEX, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit });
    try
      {
