...
public class LoyaltyChallengeCustomerStatesDriver extends ReportDriver
{
  ...
  @Override
  public void produceReport(Report report, Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params, int tenantID)
  {
