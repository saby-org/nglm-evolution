...
public class TokenReportDriver extends ReportDriver
{
  ...
  @Override public void produceReport(Report report, final Date reportGenerationDate, String zookeeper, String kafka, String elasticSearch, String csvFilename, String[] params)
  {
    ...
    String esIndexSubscriber = getSubscriberProfileIndex(reportGenerationDate); //"subscriberprofile";
    String defaultReportPeriodUnit = report.getDefaultReportPeriodUnit();
    int defaultReportPeriodQuantity = report.getDefaultReportPeriodQuantity();
    log.debug("PHASE 1 : read ElasticSearch");
    TokenReportESReader.read(topic, kafka, zookeeper, elasticSearch, esIndexSubscriber, reportGenerationDate, defaultReportPeriodQuantity, defaultReportPeriodUnit);
    //TokenReportESReader.main(new String[] { topic, kafka, zookeeper, elasticSearch, esIndexSubscriber, String.valueOf(defaultReportPeriodQuantity), defaultReportPeriodUnit });
    try
      {
    ...
    TokenReportCsvWriter.main(new String[] { kafka, topic, csvFilename });
