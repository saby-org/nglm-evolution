...
public class TokenReportESReader
{

  private static final Logger log = LoggerFactory.getLogger(TokenReportESReader.class);
  ...
  public static void read(String topicName, String kafkaNodeList, String kzHostList, String esNode, String esIndexCustomer, final Date reportGenerationDate, Integer reportPeriodQuantity, String reportPeriodUnit)
  {
    ...
    ReportEsReader reportEsReader = new ReportEsReader(TokenReportObjects.KEY_STR, topicName, kafkaNodeList, kzHostList, esNode, esIndexWithQuery, true);
