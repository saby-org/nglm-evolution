			...
			if(smtpMsg != null && trans!=null && smtpMsg.getHeader("From")!=null){
				try {
					...
					if (!isTimeout) {
						...
						//delivered
						mailNotificationRequest.setDeliveryStatus(DeliveryStatus.Delivered);
					...
					if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.CAN_NOT_OPEN_CONNECTION.getReturnCode()){
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.CAN_NOT_OPEN_CONNECTION.getReturnCode()).toString());
						isConnectionError = true;
					}else if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.CONNECTION_DROPPED.getReturnCode()){
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.CONNECTION_DROPPED.getReturnCode()).toString());
						isConnectionError = true;
...
//						this.smtpDriver.sendConnectionStatusTrap(false,null);
					...
					if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.SERVER_NOT_AVAILABLE.getReturnCode())
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.SERVER_NOT_AVAILABLE.getReturnCode()).toString());
					else if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.MAILBOX_FULL.getReturnCode())
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.QUEUE_FULL, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.MAILBOX_FULL.getReturnCode()).toString());
					else if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.DISK_FULL.getReturnCode())
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.DISK_FULL.getReturnCode()).toString());
					else if(trans!=null && trans.getLastReturnCode() == NotificationStatusCode.OUTGOING_MESSAGE_TIMEOUT.getReturnCode())
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.OUTGOING_MESSAGE_TIMEOUT.getReturnCode()).toString());
					  ...
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.PAGE_UNAVAILABLE.getReturnCode()).toString());
					  ...
					  completeDeliveryRequest(mailNotificationRequest, mailNotificationRequest.getDeliveryRequestID(), MAILMessageStatus.ERROR, DeliveryStatus.FailedRetry, NotificationStatusCode.fromReturnCode(NotificationStatusCode.AUTHENTICATION_IS_REQUIRED.getReturnCode()).toString());
