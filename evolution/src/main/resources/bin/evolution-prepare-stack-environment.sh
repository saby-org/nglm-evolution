...
#
#  POINTFULFILLMENTMANAGER -- configuration
#

POINTFULFILLMENTMANAGER_CONFIGURATION=`echo $POINTFULFILLMENTMANAGER_CONFIGURATION | sed 's/ /\n/g' | uniq`
POINTFULFILLMENTMANAGER_PROMETHEUS=
POINTFULFILLMENTMANAGER_ENABLED=false
...
do
   ...
   export MONITORING_PORT=`echo $TUPLE | cut -d: -f3`
   export DEBUG_PORT=`echo $TUPLE | cut -d: -f4`
   if [ -n "$POINTFULFILLMENTMANAGER_PROMETHEUS" ]; then
     POINTFULFILLMENTMANAGER_PROMETHEUS="$POINTFULFILLMENTMANAGER_PROMETHEUS,'$HOST:$MONITORING_PORT'"
   else
     POINTFULFILLMENTMANAGER_PROMETHEUS="'$HOST:$MONITORING_PORT'"
   fi
  POINTFULFILLMENTMANAGER_ENABLED=true
done
export POINTFULFILLMENTMANAGER_PROMETHEUS
export POINTFULFILLMENTMANAGER_ENABLED
...
export POINTFULFILLMENTMANAGER_HEAP_OPTS="-Xms$POINTFULFILLMENTMANAGER_MEMORY -Xmx$POINTFULFILLMENTMANAGER_MEMORY"
...
export POINTFULFILLMENTMANAGER_CONTAINER_MEMORY_LIMIT=$(memory_limit $POINTFULFILLMENTMANAGER_MEMORY)
