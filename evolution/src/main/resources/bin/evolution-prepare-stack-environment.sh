...
do
   ...
   if [ -n "$NOTIFICATIONMANAGER_SMS_PROMETHEUS" ]; then
     NOTIFICATIONMANAGER_CONFIGURATION_SMS_PROMETHEUS="$NOTIFICATIONMANAGER_CONFIGURATION_SMS_PROMETHEUS,'$HOST:$MONITORING_PORT'"
   else
     NOTIFICATIONMANAGER_CONFIGURATION_SMS_PROMETHEUS="'$HOST:$MONITORING_PORT'"
   fi
...
do
   ...
   if [ -n "$NOTIFICATIONMANAGER_MAIL_PROMETHEUS" ]; then
     NOTIFICATIONMANAGER_CONFIGURATION_MAIL_PROMETHEUS="$NOTIFICATIONMANAGER_CONFIGURATION_MAIL_PROMETHEUS,'$HOST:$MONITORING_PORT'"
   else
     NOTIFICATIONMANAGER_CONFIGURATION_MAIL_PROMETHEUS="'$HOST:$MONITORING_PORT'"
   fi
...
do
   ...
   if [ -n "$REPORTMANAGER_PROMETHEUS" ]; then
     REPORTMANAGER_PROMETHEUS="$REPORTMANAGER_PROMETHEUS,'$HOST:$MONITORING_PORT:$DEBUG_PORT'"
   else
     REPORTMANAGER_PROMETHEUS="'$HOST:$MONITORING_PORT:$DEBUG_PORT'"
   fi
...
do
   ...
   if [ -n "$REPORTSCHEDULER_PROMETHEUS" ]; then
     REPORTSCHEDULER_PROMETHEUS="$REPORTSCHEDULER_PROMETHEUS,'$HOST:$MONITORING_PORT:$DEBUG_PORT'"
   else
     REPORTSCHEDULER_PROMETHEUS="'$HOST:$MONITORING_PORT:$DEBUG_PORT'"
   fi
