...
#
#  elasticsearchmanager -- configuration
#

export ELASTICSEARCHMANAGER_ENABLED=true
export ELASTICSEARCHMANAGER_PROMETHEUS="'$ELASTICSEARCHMANAGER_HOST:$ELASTICSEARCHMANAGER_MONITORING_PORT'"
...
GUI_FWK_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_FWK_WEB_SERVER" ]; then
     ...
     GUI_FWK_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_FWK_WEB_SERVER_HOST_EXTERNAL
...
GUI_FWK_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_FWK_API_SERVER" ]; then
     ...
     GUI_FWK_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_FWK_API_SERVER_HOST_EXTERNAL
...
do
   ...
   if [ -n "$GUI_PROMETHEUS" ]; then
     GUI_PROMETHEUS="$GUI_PROMETHEUS,'$HOST:$PORT'"
   else
     GUI_PROMETHEUS="'$HOST:$PORT'"
   fi
done
...
GUI_CSR_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_CSR_WEB_SERVER" ]; then
     ...
     GUI_CSR_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_CSR_WEB_SERVER_HOST_EXTERNAL
...
GUI_CSR_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_CSR_API_SERVER" ]; then
     ...
     GUI_CSR_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_CSR_API_SERVER_HOST_EXTERNAL
...
GUI_ITM_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_ITM_WEB_SERVER" ]; then
     ...
     GUI_ITM_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_ITM_WEB_SERVER_HOST_EXTERNAL
...
GUI_ITM_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_ITM_API_SERVER" ]; then
     ...
     GUI_ITM_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_ITM_API_SERVER_HOST_EXTERNAL
...
GUI_JMR_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_JMR_WEB_SERVER" ]; then
     ...
     GUI_JMR_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_JMR_WEB_SERVER_HOST_EXTERNAL
...
GUI_JMR_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_JMR_API_SERVER" ]; then
     ...
     GUI_JMR_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_JMR_API_SERVER_HOST_EXTERNAL
...
GUI_OPC_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_OPC_WEB_SERVER" ]; then
     ...
     GUI_OPC_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_OPC_WEB_SERVER_HOST_EXTERNAL
...
GUI_OPC_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_OPC_API_SERVER" ]; then
     ...
     GUI_OPC_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_OPC_API_SERVER_HOST_EXTERNAL
...
GUI_IAR_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_IAR_WEB_SERVER" ]; then
     ...
     GUI_IAR_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_IAR_WEB_SERVER_HOST_EXTERNAL
...
GUI_IAR_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_IAR_API_SERVER" ]; then
     ...
     GUI_IAR_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_IAR_API_SERVER_HOST_EXTERNAL
...
GUI_OPR_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_OPR_WEB_SERVER" ]; then
     ...
     GUI_OPR_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_OPR_WEB_SERVER_HOST_EXTERNAL
...
GUI_OPR_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_OPR_API_SERVER" ]; then
     ...
     GUI_OPR_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_OPR_API_SERVER_HOST_EXTERNAL
...
GUI_STG_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_STG_WEB_SERVER" ]; then
     ...
     GUI_STG_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_STG_WEB_SERVER_HOST_EXTERNAL
...
GUI_STG_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_STG_API_SERVER" ]; then
     ...
     GUI_STG_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_STG_API_SERVER_HOST_EXTERNAL
...
GUI_SBM_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_SBM_WEB_SERVER" ]; then
     ...
     GUI_SBM_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_SBM_WEB_SERVER_HOST_EXTERNAL
...
GUI_SBM_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_SBM_API_SERVER" ]; then
     ...
     GUI_SBM_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_SBM_API_SERVER_HOST_EXTERNAL
...
GUI_LPM_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_LPM_WEB_SERVER" ]; then
     ...
     GUI_LPM_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_LPM_WEB_SERVER_HOST_EXTERNAL
...
GUI_LPM_API_SERVER_HOST_EXTERNAL=
...
do
   ...
   if [ -z "$GUI_LPM_API_SERVER" ]; then
     ...
     GUI_LPM_API_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
...
export GUI_LPM_API_SERVER_HOST_EXTERNAL

#
#  GUI DOC WEB -- configuration
#

GUI_DOC_WEB_SERVER=
GUI_DOC_WEB_SERVER_HOST=
GUI_DOC_WEB_SERVER_HOST_IP=
GUI_DOC_WEB_SERVER_HOST_EXTERNAL_IP=
GUI_DOC_WEB_SERVER_PORT=
GUI_DOC_WEB_SERVER_HOST_EXTERNAL=
...
do
   ...
   export PORT=`echo $TUPLE | cut -d: -f5`
   export HOST_EXTERNAL=`echo $TUPLE | cut -d: -f6`
   if [ -z "$GUI_DOC_WEB_SERVER" ]; then
     GUI_DOC_WEB_SERVER="$HOST:$PORT"
     GUI_DOC_WEB_SERVER_HOST="$HOST"
     GUI_DOC_WEB_SERVER_HOST_IP="$HOST_IP"
     GUI_DOC_WEB_SERVER_HOST_EXTERNAL_IP="$HOST_EXTERNAL_IP"
     GUI_DOC_WEB_SERVER_PORT="$PORT"
     GUI_DOC_WEB_SERVER_HOST_EXTERNAL="$HOST_EXTERNAL"
   fi
done
export GUI_DOC_WEB_SERVER
export GUI_DOC_WEB_SERVER_HOST
export GUI_DOC_WEB_SERVER_HOST_IP
export GUI_DOC_WEB_SERVER_HOST_EXTERNAL_IP
export GUI_DOC_WEB_SERVER_PORT
export GUI_DOC_WEB_SERVER_HOST_EXTERNAL
...
do
   ...
   export HOST_IP=`echo $TUPLE | cut -d: -f3`
   export HOST_EXTERNAL_IP=`echo $TUPLE | cut -d: -f4`
   export HOST_EXTERNAL=`echo $TUPLE | cut -d: -f5`
   if [ -z "$GUI_ONSSL_SERVER_HOST" ]; then
     GUI_ONSSL_SERVER_HOST="$HOST"
   fi
    if [ -z "$GUI_ONSSL_SERVER_ADDRESS" ]; then
     GUI_ONSSL_SERVER_ADDRESS="$HOST_EXTERNAL"
   fi
done
export GUI_ONSSL_SERVER_HOST
export GUI_ONSSL_SERVER_ADDRESS
...
do
   ...
   if [ -z "$SMSC_CONNECTION_1" ]; then
     ...
     SMSC_HOST="$HOST_IP"
     SMSC_PORT="$SMPP_PORT"
   elif [ -z "$SMSC_CONNECTION_2" ]; then
     SMSC_CONNECTION_2="$HOST_IP:$SMPP_PORT"
   fi
done
export SMSC_CONNECTION_1
export SMSC_CONNECTION_2
export SMSC_HOST
export SMSC_PORT
...
EXTRACTMANAGER_PROMETHEUS=
EXTRACTMANAGER_ENABLED=false
...
do
   ...
   export MONITORING_PORT=`echo $TUPLE | cut -d: -f3`
   export DEBUG_PORT=`echo $TUPLE | cut -d: -f4`
   if [ -n "$EXTRACTMANAGER_PROMETHEUS" ]; then
     EXTRACTMANAGER_PROMETHEUS="$EXTRACTMANAGER_PROMETHEUS,'$HOST:$MONITORING_PORT'"
   else
     EXTRACTMANAGER_PROMETHEUS="'$HOST:$MONITORING_PORT'"
   fi
  EXTRACTMANAGER_ENABLED=true
done
export EXTRACTMANAGER_PROMETHEUS
export EXTRACTMANAGER_ENABLED
...
BACKUPMANAGER_PROMETHEUS=
BACKUPMANAGER_ENABLED=false
...
do
   ...
   export MONITORING_PORT=`echo $TUPLE | cut -d: -f3`
   export DEBUG_PORT=`echo $TUPLE | cut -d: -f4`
   if [ -n "$BACKUPMANAGER_PROMETHEUS" ]; then
     BACKUPMANAGER_PROMETHEUS="$BACKUPMANAGER_PROMETHEUS,'$HOST:$MONITORING_PORT'"
   else
     BACKUPMANAGER_PROMETHEUS="'$HOST:$MONITORING_PORT'"
   fi
  BACKUPMANAGER_ENABLED=true
done
export BACKUPMANAGER_PROMETHEUS
export BACKUPMANAGER_ENABLED
...
export EXTRACTMANAGER_HEAP_OPTS="-Xms$EXTRACTMANAGER_MEMORY -Xmx$EXTRACTMANAGER_MEMORY"
export BACKUPMANAGER_HEAP_OPTS="-Xms$BACKUPMANAGER_MEMORY -Xmx$BACKUPMANAGER_MEMORY"
export DATACUBEMANAGER_HEAP_OPTS="-Xms$DATACUBEMANAGER_MEMORY -Xmx$DATACUBEMANAGER_MEMORY"
export ELASTICSEARCHMANAGER_HEAP_OPTS="-Xms$ELASTICSEARCHMANAGER_MEMORY -Xmx$ELASTICSEARCHMANAGER_MEMORY"
export NOTIFICATIONMANAGER_HEAP_OPTS="-Xms$NOTIFICATIONMANAGER_MEMORY -Xmx$NOTIFICATIONMANAGER_MEMORY"
...
export PURCHASEFULFILLMENTMANAGER_CONTAINER_MEMORY_LIMIT=$(memory_limit $PURCHASEFULFILLMENTMANAGER_MEMORY)
...
export EXTRACTMANAGER_CONTAINER_MEMORY_LIMIT=$(memory_limit $EXTRACTMANAGER_MEMORY)
export BACKUPMANAGER_CONTAINER_MEMORY_LIMIT=$(memory_limit $BACKUPMANAGER_MEMORY)
export NOTIFICATIONMANAGER_CONTAINER_MEMORY_LIMIT=$(memory_limit $NOTIFICATIONMANAGER_MEMORY)
