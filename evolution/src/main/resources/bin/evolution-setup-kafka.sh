  ...
  echo create_topic ${topic.partner}                                                  $KAFKA_REPLICATION_FACTOR               1                                       "$TOPIC_CONFIGURATION"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${topic.bonusdelivery}                                            $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.bonusdelivery_fileconnector}                              $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.offerdelivery}                                            $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.offerdelivery_fileconnector}                              $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.messagedelivery}                                          $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.messagedelivery_fileconnector}                            $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${topic.loyaltyprogramrequest}                                    $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.loyaltyprogramresponse}                                   $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${topic.fulfillment.purchasefulfillment.routing}                  $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${topic.notificationmanagersms.routing}                           $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${topic.notificationmanagermail.routing}                          $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.notificationmanagerpush.request}                          $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.notificationmanagerpush.response}                         $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.notificationmanagerpush.internal}                         $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_CHANGELOG_50MB"  >> /app/setup/topics-evolution
  echo create_topic ${topic.notificationmanagerpush.routing}                          $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  echo create_topic ${changelog.propensityengine.propensitystate.topic}               $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_CHANGELOG_50MB"  >> /app/setup/topics-evolution
  echo create_topic ${changelog.journeytrafficengine.journeytraffic.topic}            $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_CHANGELOG_50MB"  >> /app/setup/topics-evolution
  echo create_topic ${topic.journeytraffic}                               $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.pointfulfillment.rekeyed}                             $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  echo create_topic ${topic.propensityoutput}                             $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
  ...
  curl -X POST -H "Content-Type: application/json" -d '{"schema":"{\"type\":\"record\",\"name\":\"deliverablesource\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"display\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"active\",\"type\":\"boolean\"},{\"name\":\"effectiveStartDate\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"effectiveEndDate\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"fulfillmentProviderID\",\"type\":\"string\"},{\"name\":\"externalAccountID\",\"type\":\"string\"},{\"name\":\"unitaryCost\",\"type\":\"int\"}],\"connect.version\":130,\"connect.name\":\"deliverablesource\"}"}' $MASTER_REGISTRY_URL/subjects/${topic.deliverable.source}-value/versions; echo
  curl -X POST -H "Content-Type: application/json" -d '{"schema":"{\"type\":\"record\",\"name\":\"presentation_log\",\"fields\":[{\"name\":\"msisdn\",\"type\":\"string\"},{\"name\":\"subscriberID\",\"type\":\"string\"},{\"name\":\"eventDate\",\"type\":\"long\"},{\"name\":\"callUniqueIdentifier\",\"type\":\"string\"},{\"name\":\"channelID\",\"type\":\"string\"},{\"name\":\"salesChannelID\",\"type\":\"string\"},{\"name\":\"userID\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"presentationToken\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"presentationStrategyID\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"transactionDurationMs\",\"type\":\"int\"},{\"name\":\"offerIDs\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"offerScores\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"positions\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"controlGroupState\",\"type\":\"string\"},{\"name\":\"scoringStrategyIDs\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"retailerMsisdn\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"rechargeAmount\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"balance\",\"type\":[\"null\",\"double\"],\"default\":null}],\"connect.version\":129,\"connect.name\":\"presentation_log\"}"}' $MASTER_REGISTRY_URL/subjects/${topic.presentationlog}-value/versions; echo
  curl -X POST -H "Content-Type: application/json" -d '{"schema":"{\"type\":\"record\",\"name\":\"acceptance_log\",\"fields\":[{\"name\":\"msisdn\",\"type\":\"string\"},{\"name\":\"subscriberID\",\"type\":\"string\"},{\"name\":\"eventDate\",\"type\":\"long\"},{\"name\":\"callUniqueIdentifier\",\"type\":\"string\"},{\"name\":\"channelID\",\"type\":\"string\"},{\"name\":\"salesChannelID\",\"type\":\"string\"},{\"name\":\"userID\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"presentationToken\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"presentationStrategyID\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"transactionDurationMs\",\"type\":\"int\"},{\"name\":\"controlGroupState\",\"type\":\"string\"},{\"name\":\"offerID\",\"type\":\"string\"},{\"name\":\"fulfilledDate\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"position\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"actionCall\",\"type\":[\"null\",\"int\"],\"default\":null}],\"connect.version\":129,\"connect.name\":\"acceptance_log\"}"}' $MASTER_REGISTRY_URL/subjects/${topic.acceptancelog}-value/versions; echo
