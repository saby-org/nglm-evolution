...
echo create_topic ${topic.predictionsettings}                                       $KAFKA_REPLICATION_FACTOR               1                                       "$TOPIC_CONFIGURATION"   >> /app/setup/topics-evolution
echo create_topic ${topic.predictionsettingsmetadata}                               $KAFKA_REPLICATION_FACTOR               1                                       "$TOPIC_CONFIGURATION"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.subscriberprofileforceupdate_fileconnector}               $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.tokenredeemed_fileconnector}                              $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.journeystatistic}                                         $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.journeymetric}                                            $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.subscriberpredictionspush}                                $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.subscriberpredictionsrequest}                             $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.badgeobjective}                                           $KAFKA_REPLICATION_FACTOR               1                                       "$TOPIC_CONFIGURATION"   >> /app/setup/topics-evolution
...
echo create_topic ${changelog.evolutionengine.subscriberstate.topic}                $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_CHANGELOG"       >> /app/setup/topics-evolution
echo create_topic ${changelog.evolutionengine.extendedsubscriberprofile.topic}      $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_CHANGELOG"       >> /app/setup/topics-evolution
echo create_topic ${topic.externaldeliveryrequest_fileconnector}                    $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.presentationlog_fileconnector}                            $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.acceptancelog_fileconnector}                              $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.voucherchange.response}                                   $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.edrdetails}                                               $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.otpinstancechange.response}                               $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.subscriberProfileForceUpdateResponse}                     $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.customcriteria}                                           $KAFKA_REPLICATION_FACTOR               1                                       "$TOPIC_CONFIGURATION"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.badgechange.response}                                   	$KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS_OUT              "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
...
echo create_topic ${topic.importedoffers.dnbo}                                      $KAFKA_REPLICATION_FACTOR               $SUBSCRIBER_PARTITIONS                  "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
echo create_topic ${topic.importedoffers.dnbo_fileconnector}                        $KAFKA_REPLICATION_FACTOR               $FILECONNECTOR_PARTITIONS_SMALL         "$TOPIC_DATA_TWO_DAYS"   >> /app/setup/topics-evolution
