...
exec kafka-run-class -name propensityengine -loggc com.evolving.nglm.evolution.PropensityEngine /app/runtime $BROKER_SERVERS $KEY $KAFKA_REPLICATION_FACTOR $KAFKA_STREAMS_STANDBY_REPLICAS ${propensityengine.streamthreads}
