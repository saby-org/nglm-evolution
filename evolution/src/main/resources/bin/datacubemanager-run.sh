...
exec kafka-run-class -name datacubemanager -loggc com.evolving.nglm.evolution.datacubes.DatacubeManager /app/runtime $BROKER_SERVERS $KEY $ELASTICSEARCH_HOST $ELASTICSEARCH_PORT
