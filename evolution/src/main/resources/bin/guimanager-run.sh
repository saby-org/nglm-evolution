...
case "${ENTRYPOINT}" in
  ...
  "reportscheduler")
    ...
    ;;
  "thirdpartymanager")
    exec kafka-run-class -name thirdPartyManager -loggc com.evolving.nglm.evolution.ThirdPartyManager $KEY $API_PORT $GUI_FWK_API_SERVER $THREADPOOL_SIZE $GUIMANAGER_HOST $GUIMANAGER_PORT $THIRDPARTYMANAGER_API_PROTOCOL $THIRDPARTYMANAGER_API_TEMP_KEYPASS
    ;;
  "dnboproxy")
