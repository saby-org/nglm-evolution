...
exec kafka-run-class -name purchaseFulfillmentManager -loggc com.evolving.nglm.evolution.purchase.PurchaseFulfillmentManager $KEY $PLUGIN_NAME $PLUGIN_CONFIGURATION
