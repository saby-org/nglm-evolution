...
export REDIS_CONFIGURATION_IOMCACHE="001:${KAFKA_HOST}:${KAFKA_HOST_IP}:6389 002:${KAFKA_HOST}:${KAFKA_HOST_IP}:6390"
...
export SIMPLETRANSFORM_CONFIGURATION="presentationlog-001:${KAFKA_HOST}:com.evolving.nglm.evolution.PresentationLogTransformer:PRESENTATIONLOG_JSON_TOPIC:PRESENTATIONLOG_TOPIC presentationdetailslog-001:${KAFKA_HOST}:com.evolving.nglm.evolution.PresentationDetailsLogTransformer:PRESENTATIONDETAILSLOG_JSON_TOPIC:PRESENTATIONDETAILSLOG_TOPIC acceptancelog-001:${KAFKA_HOST}:com.evolving.nglm.evolution.AcceptanceLogTransformer:ACCEPTANCELOG_JSON_TOPIC:ACCEPTANCELOG_TOPIC interactionlog-001:${KAFKA_HOST}:com.evolving.nglm.evolution.InteractionLogTransformer:INTERACTIONLOG_JSON_TOPIC:INTERACTIONLOG_TOPIC"
export PROFILEENGINE_CONFIGURATION="001:${KAFKA_HOST}:9601"
export SUBSCRIBERMANAGER_CONFIGURATION="001:${KAFKA_HOST}:9621"
export NBO_TO_REDIS_CONFIGURATION="accept-001:${KAFKA_HOST}:IOMKafkaAcceptedItems:2 present-001:${KAFKA_HOST}:IOMKafkaPresentedItems:1 present-details-001:${KAFKA_HOST}:IOMKafkaPresentedDetailsItems:3"
...
export IOMCONFIGURATIONLOADER_HOST=${KAFKA_HOST}
...
export IOM_DB_PRODUCTION=FALSE
export IOM_DB_HOST=52.42.125.170
export IOM_DB_USER=sa
export IOM_DB_PASSWORD='blogic123!@#'
export IOM_DB_DATABASE=db_xxxx
