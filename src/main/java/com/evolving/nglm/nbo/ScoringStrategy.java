...
public class ScoringStrategy extends GUIManagedObject
{
  ...
  *****************************************/
  ...
  public static Object pack(Object value)
  {
    ...
    struct.put("offerType", scoringStrategy.getOfferType().getOfferTypeName());
  ...
  *****************************************/
  ...
  public ScoringStrategy(JSONObject jsonRoot, long epoch, GUIManagedObject existingScoringStrategyUnchecked) throws GUIManagerException
  {
    ...
    *****************************************/
    ...
    super(jsonRoot, "scoringStrategyID", (existingScoringStrategyUnchecked != null) ? existingScoringStrategyUnchecked.getEpoch() : epoch);
    ...
    if (existingScoringStrategy != null && existingScoringStrategy.getAccepted())
      {
        ...
        epochChanged = epochChanged || ! Objects.equals(getName(), existingScoringStrategy.getName());
