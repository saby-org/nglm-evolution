...
public class PresentationDetailsLog implements SubscriberStreamEvent
{
  /*****************************************
  *
  *  standard formats
  ...
  *****************************************/
  ...
  static
  {
    ...
    schemaBuilder.name("presentation_details_log");
  ...
  private static ConnectSerde<PresentationDetailsLog> serde = new ConnectSerde<PresentationDetailsLog>(schema, false, PresentationDetailsLog.class, PresentationDetailsLog::pack, PresentationDetailsLog::unpack);
  ...
  public static ConnectSerde<PresentationDetailsLog> serde() { return serde; }
  ...
  *****************************************/
  ...
  public PresentationDetailsLog(String subscriberID, String offerID, String channelID, String userID, Date eventDate, Integer position)
  {
  ...
  *****************************************/
  ...
  public PresentationDetailsLog(JSONObject jsonRoot)
  {
  ...
  *****************************************/
  ...
  {
    PresentationDetailsLog presentationDetailsLog = (PresentationDetailsLog) value;
    Struct struct = new Struct(schema);
    struct.put("subscriberID", presentationDetailsLog.getSubscriberID());
    struct.put("offerID", presentationDetailsLog.getOfferID());
    struct.put("channelID", presentationDetailsLog.getChannelID());
    struct.put("userID", presentationDetailsLog.getUserID());
    struct.put("eventDate", presentationDetailsLog.getEventDate());
    struct.put("position", presentationDetailsLog.getPosition());
    return struct;
  }
  ...
  *****************************************/
  ...
  public static PresentationDetailsLog unpack(SchemaAndValue schemaAndValue)
  {
    //
    //  data
    //
    ...
    return new PresentationDetailsLog(subscriberID, offerID, channelID, userID, eventDate, position);
  }
}