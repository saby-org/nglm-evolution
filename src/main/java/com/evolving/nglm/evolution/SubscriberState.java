...
public class SubscriberState implements SubscriberStreamOutput
{
  ...
  *****************************************/
  ...
  static
  {
    ...
    schemaBuilder.field("subscriberProfile", SubscriberProfile.schema());
  ...
  *****************************************/
  ...
  public SubscriberState(String subscriberID)
  {
    ...
    this.subscriberProfile = new SubscriberProfile(subscriberID);
  ...
  *****************************************/
  ...
  private SubscriberState(String subscriberID, SubscriberProfile subscriberProfile, Set<JourneyState> journeyStates, boolean subscriberStatusUpdated, List<FulfillmentRequest> fulfillmentRequests, List<JourneyStatistic> journeyStatistics, SubscriberTrace subscriberTrace)
  {
    this.subscriberID = subscriberID;
  ...
  *****************************************/
  ...
  public SubscriberState(SubscriberState subscriberState)
  {
    ...
    this.subscriberProfile = new SubscriberProfile(subscriberState.getSubscriberProfile());
    this.subscriberStatusUpdated = subscriberState.getSubscriberStatusUpdated();
  ...
  *****************************************/
  ...
  public static Object pack(Object value)
  {
    ...
    struct.put("subscriberProfile", SubscriberProfile.pack(subscriberState.getSubscriberProfile()));
    struct.put("journeyStates", packJourneyStates(subscriberState.getJourneyStates()));
    struct.put("subscriberStatusUpdated", subscriberState.getSubscriberStatusUpdated());
  ...
  *****************************************/
  ...
  public static SubscriberState unpack(SchemaAndValue schemaAndValue)
  {
    ...
    SubscriberProfile subscriberProfile = SubscriberProfile.unpack(new SchemaAndValue(schema.field("subscriberProfile").schema(), valueStruct.get("subscriberProfile")));
    ...
    return new SubscriberState(subscriberID, subscriberProfile, journeyStates, subscriberStatusUpdated, fulfillmentRequests, journeyStatistics, subscriberTrace);
  }
