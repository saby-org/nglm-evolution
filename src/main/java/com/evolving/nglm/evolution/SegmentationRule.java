  ...
  *****************************************/
  ...
  public SegmentationRule(JSONObject jsonRoot, long epoch, GUIManagedObject existingSegmentationRuleUnchecked) throws GUIManagerException
  {
    ...
    *****************************************/
    ...
    super(jsonRoot, "segmentationRuleID", (existingSegmentationRuleUnchecked != null) ? existingSegmentationRuleUnchecked.getEpoch() : epoch);
    ...
    if (existingSegmentationRule != null && existingSegmentationRule.getAccepted())
      {
        ...
        epochChanged = epochChanged || ! Objects.equals(getName(), existingSegmentationRule.getName());
